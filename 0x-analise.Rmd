...
1. Qual é a magnitude do dano causado?
1. As mensurações variam com o tempo?
1. Qual é frequência com que se identificam os danos?
1. Como se dá a distribuição geográfica dos danos patrimoniais?
1. Como as características dos processos impactam os danos patrimoniais?
    - Esfera
    - Instancia
    - Tipo da condenação
1. Como as características dos condenados impactam os danos patrimoniais?
    - Órgão
    - Tipo de pessoa

Já quando considerarmos danos morais, as questões norteadoras serão:

1. Segundo os dados do CNIA, quais são os principais danos causados?
1. As mensurações variam com o tempo?
1. Qual é frequência com que se identificam os danos?
